...
%                       sequential SOS but with a clearly infeasible
%                       intial guess.
%
...
function [fval_array, solverTimes_total,buildTimes,iteration_array,solStatus_array,solverStats] = ROA_Nlink_sequential_badInit(noRuns,deg,Nmax)
