...
%                       region-of-attraction for the N-link robot arm.
%                       using sequential SOS.
%
...
function [fval_array, solverTimes_total,buildTimes,iteration_array,solStatus_array,solverStats] = ROA_Nlink_sequential(noRuns,deg,Nmax)
