...
sos2 = struct('x',V, ...                           % dec.var
              ...
              'p',[K;s2;s3;s4;s5;s6;s7;s8;s9;s10;b]);    % parameter
...
% fix level set; for b >= 0.001 after first iteration problem is infeasible
bval = 0.0001;
...
n_con1 = S1.stats.conic.size_A(1)
n_dec1 = S1.stats.conic.size_A(2)

n_con2 = S2.stats.conic.size_A(1)
n_dec2 = S2.stats.conic.size_A(2)
